  ...
  methods: {
    ...
    loadVaribles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (resp.data.code === 'ok') _this3.varibles = resp.data.result;
      })();
    },
