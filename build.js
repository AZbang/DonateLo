  ...
  methods: {
    ...
    closeService() {
      this.$validator.validateAll().then(result => {
        if (result) this.isOpenEditor = false;else Materialize.toast('Неверно указаны данные!');
      });
    },
    deleteService() {}
  }
