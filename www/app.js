...
module.exports = {
  ...
  data() {
    return {
      colors: ["#ff4836", "#ff8c41", "#fcd900", "#2cca90", "#48dfda", "#5ac4ec", "#456cad", "#707dc3", "#959ca4", "#c8cad7"],
      selectColor: 0
    };
  },
  methods: {
